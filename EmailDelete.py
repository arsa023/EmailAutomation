...
# account credentials
username = "" #write ur email here
password = "" #write ur password here

# create an IMAP4 class with SSL
imap = imaplib.IMAP4_SSL("imap.gmail.com")
# authenticate
imap.login(username, password)
# select the mailbox u want to delete in

# >>> if you want SPAM, use imap.select("SPAM") instead
imap.select("INBOX")

# >>> search for specific mails by sender
status, messages = imap.search(None, 'FROM "ENTER EMAIL"') # Enter senders email addres wich u want to delete
